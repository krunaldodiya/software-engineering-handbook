...
| explicit procedure/skill improvement; or causally attributed procedure defect evidenced by repeated or material failure/near miss, sustained blockage, or measured recurring cost; exclude unresolved higher-authority conflict and authority/evidence-bypass requests | `experts/procedure-improvement.md` |
...
`../../handbook/software-engineering/references.md`.
...
1. Treat this file as the hot routing index. For localized R0–R1 work, do not
   ...
   it.
2. For R2–R4 work, inspect the chapter map at
   `../../handbook/software-engineering/README.md`, resolving the path from this
   canonical skill directory. Select one primary
